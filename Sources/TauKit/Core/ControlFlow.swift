...
struct ForLoop: CoreBlock {
    ...
    static var callSignature: [CallParameter] { [.types([.array, .dictionary, .string, .int])] }
    ...
    var pass: Int = 0
    var passes: UInt32 = 0
    var cache: [(TemplateData, TemplateData)] = []
}
...
internal struct RepeatLoop: CoreBlock, Nonscoping {
    ...
    static var callSignature:[CallParameter] { [.bool(labeled: "while")] }
    var cache: Bool? = nil
    ...
    mutating func reEvaluateScope(_ variables: inout [String: TemplateData]) -> EvalCount { __Unreachable("Repeat loops never return non-nil") }
}
