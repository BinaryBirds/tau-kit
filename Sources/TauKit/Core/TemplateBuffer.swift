...
/// The default output object used by TauKit to stream serialized data to.
public struct TemplateBuffer {
    @RuntimeGuard public static var boolFormatter: (Bool) -> String = { $0.description }
    @RuntimeGuard public static var intFormatter: (Int) -> String = { $0.description }
...
extension TemplateBuffer: RawBlock {
